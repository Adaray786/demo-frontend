...
module.exports = function (app) {
    ...
    app.get('/add-order', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    _b.apply(_a, _c.concat([(_d.customers = _e.sent(), _d)]));
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    app.get('/add-order-name', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    app.post('/add-order-name', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    app.get('/add-order-orderDate', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            res.render('app-order-orderDate');
            return [2 /*return*/];
        });
    }); });
    app.post('/add-order-orderDate', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
